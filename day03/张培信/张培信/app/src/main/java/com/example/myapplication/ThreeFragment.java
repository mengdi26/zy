...
public class ThreeFragment extends Fragment {
    ...
    private ArrayList<ShipingJava.DataBeanX.DataBean> list;
    private MyAdapterVide myadapter;
...
initData();
    ...
    private void initData() {
        new Retrofit.Builder()
                ...
                .subscribe(new Observer<ShipingJava>() {
                    @Override
                    ...
                    @Override
                    public void onNext(ShipingJava shafaBean) {
                        List<ShipingJava.DataBeanX.DataBean> data = shafaBean.getData().getData();
                        list.addAll(data);
    ...
    private void initView(@NonNull final View itemView) {
        ...
        list = new ArrayList<>();
        myadapter = new MyAdapterVide(list,getActivity());
